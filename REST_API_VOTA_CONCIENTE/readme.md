...
![restApiVotaConciente](logo.png)

# restApiVotaConciente
...
* Create a git repository with `$ git init` and add your git user information `$ git config user.name "REST_API_VOTA_CONCIENTE" && git config user.email "contacto@dispersiondigital.com"`
* Create a remote repository on [Github][github] with the name `rest-api-vota-conciente`. It should look after: `https://github.com/rest_api_vota_conciente/rest-api-vota-conciente.git`
