...
/**
 * @module ravc/service/show-databases
 *
 * @requires lodash
 * @requires module:ravc/args
 * @requires module:ravc/db
 * @requires module:ravc/logger
 */
...
const logger = require('app/logger').getLogger('ravc.service');
